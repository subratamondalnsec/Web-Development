    ...
    <div>
      <div className="flex bg-richblack-800 p-1 gap-x-1 rounded-full max-w-max">
        <button
          ...
          className={`${
            accountType === "student"
              ? "bg-richblack-900 text-richblack-5 border-b border-white/40"
      ...
      <form onSubmit={submitHandler}>
        <div className="flex gap-x-4 mt-5">
          <label  className="w-full">
            ...
            <input
              ...
              name="firstName"
              className="bg-richblack-800 rounded-[0.75rem] w-full p-[12px] text-richblack-5 border-b border-white/40"
            />
          </label>
        ...
        <label  className="w-full ">
          <p className="text-[0.875rem] text-richblack-5 mb-1 leading-[1.375rem] mt-5">
            Email Address
